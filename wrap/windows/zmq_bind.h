...
ZMQ_BIND_API zmq_handle_t ZMQ_BIND_CALL zmqb_context_create(int io_threads);
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_context_destroy(zmq_handle_t context);

ZMQ_BIND_API zmq_handle_t ZMQ_BIND_CALL zmqb_socket_create(zmq_handle_t context, int socket_type);
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_socket_close(zmq_handle_t socket);
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_bind(zmq_handle_t socket, const char *endpoint);
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_connect(zmq_handle_t socket, const char *endpoint);
...
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_error_text(int error_code,
                                  unsigned char *buffer,
                                  int capacity);
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_version_major(void);
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_version_minor(void);
ZMQ_BIND_API int ZMQ_BIND_CALL zmqb_version_patch(void);
